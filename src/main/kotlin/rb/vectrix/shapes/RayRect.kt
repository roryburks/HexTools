...
private constructor(
    ...
    : RayRect()
{
    override val top: Double by lazy { points.map { it.y }.maxOrNull() ?: 0.0 }
    override val bottom: Double by lazy { points.map { it.y }.minOrNull() ?: 0.0 }
    override val left: Double by lazy { points.map { it.x }.minOrNull() ?: 0.0 }
    override val right: Double by lazy { points.map { it.x }.maxOrNull() ?: 0.0 }
